...
class ClickEvent:
    ...
    def serialize(self):
        ...
        fo = BytesIO()
        writer(fo, ClickEvent.schema, [asdict(self)])
        return fo.getvalue()
...
# kafka-console-consumer --bootstrap-server localhost:9092 --topic "com.udacity.lesson3.exercise2.clicks"
# kafka-console-consumer --bootstrap-server localhost:9092 --topic "com.udacity.exercise2" --from-beginning
# tail -f /var/log/journal/confluent-  ### Kafka Connect the diagnose what the issue is
